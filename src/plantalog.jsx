  ...
  return (
    <div style={{minHeight:"100vh",background:"#1b4d3e",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"24px 20px",fontFamily:"'DM Sans',sans-serif"}}>
      ...
      <div style={{display:"flex",flexDirection:"column",alignItems:"center",marginBottom:32}}>
        <img src="/apple-touch-icon.png" alt="Plantalog" style={{width:120,height:120,borderRadius:26,marginBottom:18,boxShadow:"0 4px 24px rgba(0,0,0,0.3)"}}/>
...
export default function App() {
  ...
  if (!authLoaded) return (
    <div style={{display:"flex",alignItems:"center",justifyContent:"center",height:"100vh",background:"#1b4d3e",fontFamily:"'DM Sans',sans-serif",color:"#e8e2d0",fontSize:18,flexDirection:"column",gap:16}}>
      <img src="/apple-touch-icon.png" alt="" style={{width:72,height:72,borderRadius:16,opacity:0.9}}/>
